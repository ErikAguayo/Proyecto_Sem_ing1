...
<body>
    ...
    <table id="container-producto">
        ...
        <tbody>
            ...
            //IGV incluido
            $subTotal = $data['venta']['total'] / 1.16;
            ...
            foreach ($productos as $producto) { ?>
                <tr>
                   <td align="text-center"> <?php echo $producto['cantidad']; ?></td>
            ...
            <tr class="total">
                <td class="text-right" colspan="3">Iva 16%</td>
    ...
    <div class="text-center">
                                        <h3 class="">Gracias por tu compra </h3>
                                    </div>
