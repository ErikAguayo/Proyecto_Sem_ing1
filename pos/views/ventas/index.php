        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active p-3" id="nav-ventas" role="tabpanel" aria-labelledby="nav-ventas-tab" tabindex="0">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-3">
                        <div style="display: none;" class="btn-group-toggle float-end" data-toggle="buttons">
                            <label class="btn btn-primary">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" value="DevMexShop" placeholder="Vendedor" disabled>
                        </div>
